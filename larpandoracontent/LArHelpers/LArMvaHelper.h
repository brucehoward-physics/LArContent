 ...
 */
  ...
  public:
    ...
    typedef std::map<std::string, double>
      MvaFeatureMapDbl; // an MvaFeature map that has double as the value and not an MvaFeature specifically (used currently in NeutrinoID tool)
    ...
    static pandora::StatusCode ProduceTrainingExample(const std::string& trainingOutputFile,
                                                      const bool result,
                                                      const StringVector& featureToolOrder,
                                                      TCONTAINER&& featureContainer);
     ...
     */
    template <typename... Ts, typename... TARGS>
    static MvaFeatureMap CalculateFeatures(const StringVector& featureToolOrder,
     ...
     */
    static pandora::StatusCode ProcessAlgorithmToolListToMap(const pandora::Algorithm& algorithm,
                                                             const pandora::TiXmlHandle& xmlHandle,
                                                             const std::string& listName,
                                                             StringVector& algorithToolNameVector,
  ...
  LArMvaHelper::ProduceTrainingExample(const std::string& trainingOutputFile,
                                       const bool result,
                                       const LArMvaHelper::StringVector& featureToolOrder,
                                       TCONTAINER&& featureContainer)
  {
  ...
  LArMvaHelper::CalculateFeatures(const LArMvaHelper::StringVector& featureToolOrder,
                                  const MvaFeatureToolMap<Ts...>& featureToolMap,
