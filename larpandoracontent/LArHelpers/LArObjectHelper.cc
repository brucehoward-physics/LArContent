...
template<>
const CaloHit *LArObjectHelper::TypeAdaptor::GetThisCaloHit(const CartesianVector &)
{
  return nullptr;
}

template<>
const CaloHit *LArObjectHelper::TypeAdaptor::GetThisCaloHit(const CaloHit *const &pCaloHit3D)
{
  return pCaloHit3D;
}
